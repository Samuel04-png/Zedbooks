        ...
        <BrowserRouter basename={import.meta.env.BASE_URL}>
          <AuthProvider>
            <Routes>
              ...
              <Route path="/financial-periods" element={<ProtectedRoute><AppLayout><RoleProtectedRoute allowedRoles={["super_admin", "admin", "financial_manager", "accountant", "assistant_accountant", "finance_officer", "bookkeeper"]}><FinancialPeriods /></RoleProtectedRoute></AppLayout></ProtectedRoute>} />
